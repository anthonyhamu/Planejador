    ...
    const atividade = {
        nome: "Almoço",
        data: new Date("2024-11-08T12:00:00"), // Corrigido para o formato ISO 8601
        finalizada: true
    }
    ...
    let atividades = [
        ...
        {
            nome: 'Academia',
            data: new Date("2024-12-08T19:00:00"),
            finalizada: false
        },
        {
            nome: 'Tempo livre',
            data: new Date("2024-12-08T22:00:00"),
            finalizada: false
        }
    ]
    ...
    const salvarAtividade = (event) => {
        ...
        const data = `${dia}T${hora}:00` // Adicionando o formato correto de tempo
        ...
        const atividadeExiste = atividades.find(
            (atividade) => {
